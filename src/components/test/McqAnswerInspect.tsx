    ...
    <section className='min-h-screen'>
      <div className='space-y-3'>
        ...
        <div className='flex space-x-3'>
          <p className='py-1 px-2 rounded-md border border-green-400 text-green-400 w-fit capitalize font-semibold'>{subject}</p>
          <p className='py-1 px-2 rounded-md border border-green-400 text-green-400 w-fit capitalize font-semibold'>Total Marks {TOTALMARKS}</p>
          <p className='py-1 px-2 rounded-md border border-green-400 text-green-400 w-fit capitalize font-semibold'>Total questions {TOTALQUESIONS}</p>
        </div>
      </div>
      ...
      <section>
        ...
        {answers.map(a => {
          return <article>
            <p>Submited by <span>{a.user.username}</span></p>
          </article>
        })}
      </section>
